...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	public static var psychicEvents:Array<String> =
	[
		'',
		'Hey!',
		'Set GF Speed',
	...
	function addSongUI():Void
	{
		...
		var clear_chart:FlxButton = new FlxButton(loadAutosaveBtn.x, 340, 'Clear chart', function()
		{
		...
		tab_group_song.add(clear_chart);
	...
	function addPsychicUI():Void
	{
		...
		var descText:FlxText = new FlxText(20, 200, 0, psychicEvents[0]);

		var text:FlxText = new FlxText(20, 30, 0, "Event:");
		tab_group_note.add(text);
		var eventDropDown = new FlxUIDropDownMenu(20, 50, FlxUIDropDownMenu.makeStrIdLabelArray(psychicEvents, true), function(pressed:String) {
			selectedPsychic = Std.parseInt(pressed);
			descText.text = psychicDescs[selectedPsychic];
			if(curSelectedNote != null) {
				curSelectedNote[2] = psychicEvents[selectedPsychic];
			}
		});
	...
	private function addNote():Void
	{
		...
		if(noteData > -1) {
			...
			var psych = psychicEvents[selectedPsychic];
